...
public class SGButton {
     ...
     */
    public SGButton(final ItemStack icon) {
        this.icon = icon;
    }
     ...
     */
    public SGButton withListener(final SGButtonListener listener) {
     ...
     * @param listener The listener to be called when the button is clicked.
     */
    public void setListener(final SGButtonListener listener) {
        this.listener = listener;
    }
